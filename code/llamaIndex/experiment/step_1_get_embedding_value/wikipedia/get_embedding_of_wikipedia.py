...
if __name__ == '__main__':
    ...
    documents = [generate_document_from_str(text) for text in tqdm(df['text'], desc='generating documents...')]
    ...
    get_text_embeddings_and_save(
        ...
        nodes=nodes,
        output_file_path=os.path.join(os.path.abspath('.'), 'wikipedia_embeddings.jsonl')
    )