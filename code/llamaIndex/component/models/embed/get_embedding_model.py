...
from component.models.embed.custom_huggingface_embedding import CustomHuggingFaceEmbedding

def get_embedding_model(embedding_config, device=None):
        return EmbeddingInterface(embedding_config=embedding_config, device=device)

class EmbeddingInterface(BaseEmbedding):
